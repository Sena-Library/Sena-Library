let books = [
    {
      ...
      format: 'Tapa blanda',
      isbn: '9788413145204',
      description: 'Una historia de amor y pasión con una cuenta atrás. Todo acabará Antes de diciembre. ',
      state: 'No disponible',
      ubication: 'España',
    ...
    },
    {
      ...
      format: 'Tapa blanda',
      isbn: '9788419169181',
      description: 'Luke Howland, lleno de problemas y sumido en una desesperación profunda,  y Hasley Weigel, tan despistada como optimista, no se ajustan al prototipo de pareja perfecta.',
      state: 'Disponible',
      ubication: 'España',
    ...
    },
    {
      ...
      idiom: 'Castellano',
      price: 75000,
      format: 'Sin formato definido',
      isbn: '9789584297464',
      description: 'COMO es una guía clara y completa para que el alimento se convierta en tu mejor medicina, porque la decisión de comer sano no es tan complicada y cara como te imaginas. De la mano del Dr. Jaramillo ?médico funcional, experto en metabolismo, nutrición y bioquímica?, podrás entender cómo equilibrar tu dieta, leer etiquetas para elegir mejor los alimentos, ayunar sin temores, desinflamar tu cuerpo',
      state: 'No disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
      publicationDate: '08/06/2022',
      editorial: 'Planeta Colombia',
      pages: '640'
    },
    {
      tittle: 'Cómo ganar amigos e influir sobre las personas',
      ...
      format: 'Tapa blanda',
      isbn: '9781644730096',
      description: 'Dale Carnegie escribió este libro con el propósito de ser un suplemento a su curso sobre oratoria y relaciones humanas y nunca se imaginó que se convertiría en un éxito de ventas y que la gente lo leería, lo criticaría y viviría según sus reglas. Carnegie entrevistó a muchas personas de renombre para tomar ejemplos de sus vidas. Entre ellas están Edison, Franklin D. Rooselvelt y James Farley.',
      state: 'Disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
      publicationDate: '23 Abril 2019',
      editorial: 'B de Bolsillo',
      pages: '304 páginas'
    },
    {
      tittle: 'Cómo hacer que te pasen cosas buenas',
      author: 'Marian Rojas',
      genre: 'Autoayuda',
      idiom: 'Castellano',
      price: 80749,
    ...
    },
    {
      ...
      format: 'Tapa blanda',
      isbn: '978-8498381498',
      description: 'Autorretrato y obra testamentaria, fábula mítica y relato filosófico que interroga acerca de la relación del ser humano con su prójimo y con el mundo, El Principito concentra, con maravillosa simplicidad, la larga y constante reflexión de Saint-Exupéry sobre la amistad, el amor, la responsabilidad y el sentido de la vida, en un contexto marcado por el conflicto mundial y el desasosiego de un escritor piloto profundamente afectado por su soledad.',
      state: 'Disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
      publicationDate: '01/06/2016',
      editorial: 'Salamandra',
      pages: '96 páginas'
    },
    {
      tittle: 'El infinito en un junco',
    ...
    },
    {
      ...
      format: 'Tapa blanda',
      isbn: '9788411190312',
      description: 'A todos nos gusta comer. Pero algo estamos haciendo mal, y cada día peor. Confundidos por la industria alimentaria, la publicidad, las fake news gastronómicas y los consejos nutricionales de familiares bienintencionados, con cada bocado tomamos decisiones nefastas que nos enferman, nos engordan y nos roban energía. ¿Cómo detener esta espiral? ¿A quién creer y a quién no? ¿Cómo cambiar de hábitos sin volvernos rígidos y aburridos?',
      state: 'Disponible',
      ubication: 'España',
      publicationDate: '07/09/2022',
      editorial: 'Booket',
      pages: '320'
    },
    {
      tittle: 'HABITOS ATOMICOS',
      author: 'James Clear',
      genre: 'Autoayuda',
      idiom: 'Castellano',
      price: 79000,
      format: 'Sin formato definido',
      isbn: '9789584277954',
      description: '“Hábitos Atómicos” es un libro escrito por James Clear, un experto en formación de hábitos y autor del bestseller número 1 del New York Times. En este libro, Clear explora cómo los hábitos pueden ser el secreto para lograr el éxito y mejorar nuestra vida en general.',
      state: 'Disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
      publicationDate: '08/09/2020',
      editorial: 'PAIDOS',
      pages: '323'
    },
    {
    ...
    },
    {
      ...
      format: 'Tapa Dura',
      isbn: '9786280004013',
      description: 'A los siete años, mientras le hacía el quite a la muerte en una cama de hospital, Mario Mendoza descubrió los libros y su potencia liberadora con un ejemplar de Cuentos de hadas franceses. En ese momento se volvió lector e inició una amistad inquebrantable con aquellos objetos.',
      state: 'No disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
      publicationDate: '17 Abril 2023',
      editorial: 'Planeta Colombia',
      pages: '350'
    },
    {
      tittle: 'Los cuatro acuerdos',
      author: 'Miguel Ruiz',
      genre: 'Autoayuda',
      idiom: 'Castellano',
      price: 43699,
      ...
      state: 'Disponible',
      ubication: 'España',
      publicationDate: '23/10/1998',
      editorial: 'Urano',
      pages: '160'
    },
    {
      tittle: 'Narraciones extraordinarias',
    ...
    },
    {
      ...
      state: 'Disponible',
      ubication: 'España',
      publicationDate: '01/10/2022',
      editorial: 'ALFAGUARA',
      pages: '357'
    },
    {
      tittle: 'Una vida, muchas vidas',
    ...
    },
    {
      ...
      format: 'Sin formato definido',
      isbn: '9786287611184',
      description: 'Violeta comes into the world on a stormy day in 1920, the first girl in a family with five boisterous sons. From the start, her life is marked by extraordinary events, for the ripples of the Great War are still being felt, even as the Spanish flu arrives on the shores of her South American homeland almost at the moment of her birth.',
      state: 'Disponible',
      ubication: 'LIBRERÍA Y DISTRIBUIDORA LERNER SAS',
