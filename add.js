 ...
 function mostrarContenido() {
    ...
    if (contenido.length > 0) {
        ...
        contenido.forEach((obj) => {
            ...
            listItem.innerHTML = `
                Autor: ${obj.autor}, Título: ${obj.titulo}, Género: ${obj.genero}, Lenguaje: ${obj.lenguaje}, Precio: ${obj.precio}<br>
                <img src="${obj.imagen}" alt="Imagen de ${obj.titulo}" style="max-width: 100px;"><br>
            `;
